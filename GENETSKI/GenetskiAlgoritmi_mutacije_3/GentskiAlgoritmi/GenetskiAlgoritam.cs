...
namespace GentskiAlgoritmi
{
    class GenetskiAlgoritam
    {
        ...
        public static double funkcija(double d) //ovo menjas,minimum trazis tako sto obrnes znak x^2 -> -(x^2)
        {
            return Math.Sin(d) / 3 / d + 4 * d * d;
        }
